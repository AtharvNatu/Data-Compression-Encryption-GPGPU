    ...
    class CLFW
    {
        ...
        size_t get_global_work_size(int local_size, unsigned int global_size);
        ...
        float ocl_execute_kernel(size_t ocl_global_work_size, size_t ocl_local_work_size);

        void host_alloc_mem(void** host_ptr, string host_type, size_t host_size);
        void host_release_mem(unsigned char** host_ptr);
