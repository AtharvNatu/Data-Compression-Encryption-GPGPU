...
double aes_cpu_decrypt_huffman_ffi(const char* input_path, const char* output_path, const char* password)
{
...
{
	// const char* enc_input_file_path = "/home/uttkarsh/VIT/4th_Year/Major_Project/Code/Integration/CPU/2_with_metadata_validation/data/Novel.txt";
	// const char* enc_output_path = "/home/uttkarsh/VIT/4th_Year/Major_Project/Code/Integration/CPU/2_with_metadata_validation/data/output";

	// const char* dec_input_file_path = "/home/uttkarsh/VIT/4th_Year/Major_Project/Code/Integration/CPU/2_with_metadata_validation/data/output/Novel.txt.enc";
	// const char* dec_output_path = "/home/uttkarsh/VIT/4th_Year/Major_Project/Code/Integration/CPU/2_with_metadata_validation/data/output";

	const char* password = "1234";

	const char* enc_input_file_path = "C:\\Users\\Atharv\\Desktop\\Novel.txt";
	const char* enc_output_path = "C:\\Users\\Atharv\\Desktop\\Test";

	cout << aes_cpu_encrypt_huffman_ffi(enc_input_file_path, enc_output_path, password) << " ms" << endl;
	// cout << aes_ecb_encrypt(enc_input_file_path, enc_output_path, password) << " ms" << endl;
	

	const char* dec_input_file_path = "C:\\Users\\Atharv\\Desktop\\Test\\Novel.txt.enc";
	const char* dec_output_path = "C:\\Users\\Atharv\\Desktop\\Test";

	cout << aes_cpu_decrypt_huffman_ffi(dec_input_file_path, dec_output_path, password) << " ms" << endl;
	// cout << aes_ecb_decrypt(dec_input_file_path, dec_output_path, password) << " ms" << endl;
