...
void aes_ocl_byte_sub(byte_t state[AES_STATE_SIDE][AES_STATE_SIDE])
{
    // Code
...
void aes_ocl_shift_rows(byte_t state[AES_STATE_SIDE][AES_STATE_SIDE])
{
    // Code
...
void aes_ocl_mix_columns(byte_t state[AES_STATE_SIDE][AES_STATE_SIDE])
{
